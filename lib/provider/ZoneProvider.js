...
var ZoneProvider = function (_Provider) {
  _inherits(ZoneProvider, _Provider);

  function ZoneProvider() {
    _classCallCheck(this, ZoneProvider);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ZoneProvider).apply(this, arguments));
  }
